package org.borrarUsuarios.Presentacion;
...
public class IUborrarUsuarios extends JDialog {
	...
	public static void main(String[] args) {
		try {
			IUborrarUsuarios dialog = new IUborrarUsuarios();
	...
	public IUborrarUsuarios() {
		...
		{
			JLabel lblCrearAsignaturas = new JLabel("Borrar Usuarios");
