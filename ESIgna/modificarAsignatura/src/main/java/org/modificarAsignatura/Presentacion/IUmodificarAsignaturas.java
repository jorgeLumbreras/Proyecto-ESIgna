package org.modificarAsignatura.Presentacion;
...
public class IUmodificarAsignaturas extends JDialog {
	...
	public static void main(String[] args) {
		try {
			IUmodificarAsignaturas dialog = new IUmodificarAsignaturas();
	 ...
	 * Create the dialog.
	 */
	public IUmodificarAsignaturas() {
		setTitle("Modificar Asignaturas");
		...
		{
			JLabel lblCrearAsignaturas = new JLabel("Modificar Asignaturas");
