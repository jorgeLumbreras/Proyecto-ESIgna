package org.modificarUsuario.Presentacion;
...
public class IUmodificarUsuarios extends JDialog {
	...
	public static void main(String[] args) {
		try {
			IUmodificarUsuarios dialog = new IUmodificarUsuarios();
	...
	public IUmodificarUsuarios() {
		...
		{
			JLabel lblCrearAsignaturas = new JLabel("Modificar usuarios");
