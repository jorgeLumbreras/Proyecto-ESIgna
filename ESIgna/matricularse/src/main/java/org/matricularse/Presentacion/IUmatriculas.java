package org.matricularse.Presentacion;
...
public class IUmatriculas extends JDialog {
	...
	public static void main(String[] args) {
		try {
			IUmatriculas dialog = new IUmatriculas();
	...
	public IUmatriculas() {
		...
		{
			JLabel lblCrearAsignaturas = new JLabel("Matrículas");
